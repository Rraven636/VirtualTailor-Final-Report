...
\newcolumntype{V}{>{\centering\arraybackslash\hsize=\dimexpr2\hsize+2\tabcolsep+\arrayrulewidth\relax}X}
\newcolumntype{W}{>{\centering\arraybackslash\hsize=\dimexpr3\hsize+4\tabcolsep+2\arrayrulewidth\relax}X}
