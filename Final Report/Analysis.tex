...
However, there were certain instances where the performance of the Kinect was inadequate and negatively impacted the overall performance of the system. These are explained in the following section.  
